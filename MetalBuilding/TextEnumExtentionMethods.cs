...
namespace MoreBuilding
{
    ...
    public enum Localization
    {
        ...
        [Text(Language.portuguese, "Sucata")]
        ...
        [Text(Language.portuguese, "Metal")]
        ...
        [Text(Language.portuguese, "Vidro")]
        ...
        [Text(Language.portuguese, _Base_, "Lastro de {0}", "Para expandir a sua jangada no andar de baixo.")]
